...
1. Download the latest `EffiTrack.jar` from [here](https://github.com/se-edu/addressbook-level3/releases).
...
1. Type the command in the command box and press Enter to execute it. e.g. typing **`help`** and pressing Enter will open the help window.<br>
   ...
   * `add n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 d/Finance` : Adds a contact named `John Doe` to the Address Book.
...
Examples:
* `add n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 d/Finance`
* `add n/Betsy Crowe t/friend e/betsycrowe@example.com a/Newgate Prison p/1234567 d/Murder t/criminal`
...
2. Overwrite the empty data file it creates with the file that contains the data of your previous AddressBook home folder.
...
**Assign** | `assign task/TASK TITLE by/dd-MM-yyyy to/INDEX`<br> e.g., `assign task/Project 1 by/22-05-2023 2359 to/1`
