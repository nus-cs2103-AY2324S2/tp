...
| `* * *`  | recruiter          | leave a comment on the candidate's interview status                  | take note of the important aspects of the candidate for future reference                                                  |
| `* * *`  | recruiter          | clear the database in one single command                             | avoid typing multiple delete commands                                                                                     |
| `* * *`  | recruiter          | view the details of a candidate of a particular role in the database | have an absolute reference of the singular candidate that I am interested in                                              |
