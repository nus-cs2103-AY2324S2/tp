...
| `* * *`  | Social Worker                                            | Delete a client                                   | Remove clients that I no longer need                                              |
...
| `* * *`  | Social Worker who has physical meetings with the clients | Add appointments that I have with each client     | Keep track of the physical meetings I have with my clients                        |
| `* * *`  | Social Worker who has physical meetings with the clients | Delete appointments that I have with each client  | Remove any appointments that I no longer have                                     |
| `* * *`  | Social Worker who has physical meetings with the clients | View an appointment's information                 | Be informed of the details that the appointment involves                          |
| `* * *`  | Social Worker who has physical meetings with the clients | List out my appointments in chronological order   | Keep track of my upcoming appointments and which one to prepare for               |
