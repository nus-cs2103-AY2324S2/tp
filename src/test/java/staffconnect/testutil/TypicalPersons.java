...
public class TypicalPersons {
    ...
    public static final Person CLARA = new PersonBuilder().withFaculty("Computing")
            .withName("Clara Svarog").withPhone("9681384")
    ...
    public static final Person KAFKA = new PersonBuilder().withFaculty("Computing")
            .withName("Kafka Apache").withPhone("9452413")
