...
public class KeywordPredicateTest {
    ...
    public void test_Keyword_returnsTrue() {
        // Name
        KeywordPredicate predicate = new KeywordPredicate(ArgumentTokenizer.tokenize(" ; name : Alice", PREFIX_NAME));
        ...
        // Email
        predicate = new KeywordPredicate(ArgumentTokenizer.tokenize(" ; email : ilovepoochies@gmail.com", PREFIX_EMAIL));
        assertTrue(predicate.test(new PersonBuilder().withEmail("ilovepoochies@gmail.com").build()));

        // Address
        predicate = new KeywordPredicate(ArgumentTokenizer.tokenize(" ; address : Pooch Street 21", PREFIX_ADDRESS));
        assertTrue(predicate.test(new PersonBuilder().withAddress("Pooch Street 21").build()));

        // Salary
        predicate = new KeywordPredicate(ArgumentTokenizer.tokenize(" ; salary : $50/hr", PREFIX_SALARY));
        assertTrue(predicate.test(new StaffBuilder().withSalary("$50/hr").build()));

        // Employment
        predicate = new KeywordPredicate(ArgumentTokenizer.tokenize(" ; employment : part-time", PREFIX_EMPLOYMENT));
        assertTrue(predicate.test(new StaffBuilder().withEmployment("part-time").build()));

        // Price
        predicate = new KeywordPredicate(ArgumentTokenizer.tokenize(" ; price : $50/h", PREFIX_PRICE));
        ...
        // Skill
        predicate = new KeywordPredicate(ArgumentTokenizer.tokenize(" ; skill : dog trainer", PREFIX_SKILL));
        assertTrue(predicate.test(new MaintainerBuilder().withSkill("dog trainer").build()));

        // Commission
        predicate = new KeywordPredicate(ArgumentTokenizer.tokenize(" ; commission : $100/hr", PREFIX_COMMISSION));
        assertTrue(predicate.test(new MaintainerBuilder().withCommission("$100/hr").build()));

        // Partial keyword
        predicate = new KeywordPredicate(ArgumentTokenizer.tokenize(" ; name : Al", PREFIX_NAME));
        assertTrue(predicate.test(new PersonBuilder().withName("Alice Bob").build()));

        // Mixed-case keyword
        predicate = new KeywordPredicate(ArgumentTokenizer.tokenize(" ; name : AlIcE", PREFIX_NAME));
        assertTrue(predicate.test(new PersonBuilder().withName("Alice Bob").build()));

        // Two fields: Name & Phone
        predicate = new KeywordPredicate(ArgumentTokenizer.tokenize(" ; name : Alice ; phone : 98765432", PREFIX_NAME, PREFIX_PHONE));
    ...
    public void test_Keyword_returnsFalse() {
        ...
        KeywordPredicate predicate = new KeywordPredicate(ArgumentTokenizer.tokenize(" ; name : Carol", PREFIX_NAME));
        assertFalse(predicate.test(new PersonBuilder().withName("Alice").build()));

        // Keywords match name and phone, but does not match email
        predicate = new KeywordPredicate(ArgumentTokenizer.tokenize(" ; name : Alice ; phone : 98765432 ; email : ihatepoochies@gmail.com", PREFIX_NAME, PREFIX_PHONE));
        assertFalse(predicate.test(new PersonBuilder().withName("Alice").withPhone("98765432").withEmail("ilovepoochies@gmail.com").build()));
    }
