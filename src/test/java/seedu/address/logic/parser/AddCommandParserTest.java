...
import static seedu.address.logic.commands.CommandTestUtil.EMAIL_DESC_CORN;
...
import static seedu.address.logic.commands.CommandTestUtil.NAME_DESC_CORN;
...
public class AddCommandParserTest {
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, VALID_NAME_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + TAG_DESC_FRIEND,
                expectedMessage);

        // missing email prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + VALID_EMAIL_BOB + TAG_DESC_FRIEND,
                expectedMessage);
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + TAG_DESC_FRIEND,
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero phone
        Company expectedCompany = new CompanyBuilder(CORN).withPhone().build();
        assertParseSuccess(parser, NAME_DESC_CORN + EMAIL_DESC_CORN + TAG_DESC_HUSBAND,
