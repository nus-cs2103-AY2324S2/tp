...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + MAJOR_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedStudent));
        ...
        assertParseSuccess(parser,
                NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + MAJOR_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
    ...
    public void parse_repeatedNonTagValue_failure() {
        ...
        // multiple addresses
        assertParseFailure(parser, MAJOR_DESC_AMY + validExpectedStudentString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_MAJOR));

        // multiple fields repeated
        assertParseFailure(parser,
                validExpectedStudentString + PHONE_DESC_AMY + EMAIL_DESC_AMY + NAME_DESC_AMY + MAJOR_DESC_AMY
                        + validExpectedStudentString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NAME, PREFIX_MAJOR, PREFIX_EMAIL, PREFIX_PHONE));
        ...
        // invalid address
        assertParseFailure(parser, INVALID_MAJOR_DESC + validExpectedStudentString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_MAJOR));
        ...
        // invalid address
        assertParseFailure(parser, validExpectedStudentString + INVALID_MAJOR_DESC,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_MAJOR));
    }
