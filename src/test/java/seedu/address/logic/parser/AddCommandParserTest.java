...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser,
                ...
                + ADDRESS_DESC_BOB + FAMILY_DESC_BOB + TAG_DESC_FRIEND + REMARK_DESC_BOB, new AddCommand(expectedPerson));
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + PHONE_DESC_BOB + INCOME_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + FAMILY_DESC_BOB + TAG_DESC_FRIEND;
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser,
                           NAME_DESC_AMY + PHONE_DESC_AMY + INCOME_DESC_AMY
                                   + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + FAMILY_DESC_AMY,
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser,
                ...
                + ADDRESS_DESC_BOB + FAMILY_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
