...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + CLASS_GROUP_DESC_BOB + EMAIL_DESC_BOB + PHONE_DESC_BOB
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + CLASS_GROUP_DESC_BOB + EMAIL_DESC_BOB + PHONE_DESC_BOB
                + TELEGRAM_DESC_BOB + GITHUB_DESC_BOB;
