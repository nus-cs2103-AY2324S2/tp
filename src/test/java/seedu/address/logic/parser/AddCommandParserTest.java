...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + GITHUB_USERNAME_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedPerson));
        ...
        Person expectedPersonMultipleTechStacks = new PersonBuilder(BOB).withTechStack(VALID_TECH_STACK_PYTHON, VALID_TECH_STACK_JAVA)
                .build();
