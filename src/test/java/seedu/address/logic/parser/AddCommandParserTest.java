...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + SKILL_DESC_REACT, new AddCommand(expectedCourseMate));
    ...
    public void parse_repeatedNonSkillValue_failure() {
        String validExpectedCourseMateString = NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + SKILL_DESC_REACT;
        ...
        // multiple addresses
        assertParseFailure(parser, ADDRESS_DESC_AMY + validExpectedCourseMateString,
        ...
        // invalid address
        assertParseFailure(parser, INVALID_ADDRESS_DESC + validExpectedCourseMateString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_ADDRESS));
        ...
        // invalid address
        assertParseFailure(parser, validExpectedCourseMateString + INVALID_ADDRESS_DESC,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_ADDRESS));
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC
                + SKILL_DESC_JAVA + SKILL_DESC_REACT, Address.MESSAGE_CONSTRAINTS);
