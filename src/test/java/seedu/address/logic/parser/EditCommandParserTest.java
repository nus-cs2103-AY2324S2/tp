...
public class EditCommandParserTest {
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        descriptor = new EditStudentDescriptorBuilder().withMajor(VALID_MAJOR_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + MAJOR_DESC_AMY + EMAIL_DESC_AMY
                + TAG_DESC_FRIEND + PHONE_DESC_AMY + MAJOR_DESC_AMY + EMAIL_DESC_AMY + TAG_DESC_FRIEND
                + PHONE_DESC_BOB + MAJOR_DESC_BOB + EMAIL_DESC_BOB + TAG_DESC_HUSBAND;
        ...
        userInput = targetIndex.getOneBased() + INVALID_PHONE_DESC + INVALID_MAJOR_DESC + INVALID_EMAIL_DESC
                + INVALID_PHONE_DESC + INVALID_MAJOR_DESC + INVALID_EMAIL_DESC;
