...
public class EditCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + EMAIL_DESC_AMY + TAG_DESC_HUSBAND
                    + ADDRESS_DESC_AMY + NAME_DESC_AMY + SUBJECT_DESC_AMY + TAG_DESC_FRIEND;
