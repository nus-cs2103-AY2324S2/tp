...
public class EditCommandParserTest {
    ...
    public void parse_missingParts_failure() {
        ...
        // no field specified
        assertParseFailure(parser, VALID_ID_AMY, EditCommand.MESSAGE_NOT_EDITED);
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        Id targetId = ID_SECOND_PERSON;
        String userInput = targetId + NAME_DESC_AMY + PHONE_DESC_BOB;
        // + TAG_DESC_HUSBAND
        // + EMAIL_DESC_AMY + ADDRESS_DESC_AMY  + TAG_DESC_FRIEND;
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_BOB).withId(ID_SECOND_PERSON.toString()).build();
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        Id targetId = ID_THIRD_PERSON;
        String userInput = targetId + NAME_DESC_AMY;
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withId(ID_THIRD_PERSON.toString()).build();
        EditCommand expectedCommand = new EditCommand(targetId, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + NAME_DESC_AMY + NAME_DESC_BOB + PHONE_DESC_BOB;
        ...
        userInput = targetIndex.getOneBased() + INVALID_PHONE_DESC + INVALID_NAME_DESC + INVALID_NAME_DESC
