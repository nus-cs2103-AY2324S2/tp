...
public class AddMeetingCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, PREFIX_CLIENT_INDEX + "0" + PREFIX_DATETIME + "01-01-2024 12:00" + PREFIX_DESCRIPTION + "Project Meeting", MESSAGE_INVALID_INDEX);

        // Invalid date time
        assertParseFailure(parser, CLIENT_INDEX + "not-a-date-time" + PREFIX_DESCRIPTION + "Project Meeting", Meeting.MESSAGE_INVALID_DATE_TIME);

        // Invalid description
        assertParseFailure(parser, CLIENT_INDEX + "01-01-2024 12:00" + PREFIX_DESCRIPTION + " ", Meeting.MESSAGE_CONSTRAINTS);
