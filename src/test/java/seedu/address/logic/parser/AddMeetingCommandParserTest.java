...
public class AddMeetingCommandParserTest {
    ...
    public void parse_validArgs_returnsAddMeetingCommand() throws ParseException {
        String args = "John m/Meeting t/23-03-2024 1400-1500";
    ...
    public void parse_missingDescription_throwsParseException() {
        String args = "John m/ t/23-03-2024 1400-1500";
        assertThrows(ParseException.class, () -> parser.parse(args));
    }

    @Test
    public void parse_invalidDate_throwsParseException() {
        String args = "John m/Meeting t/2024-03-23 1400-1500";
        assertThrows(ParseException.class, () -> parser.parse(args));
    }

    @Test
    public void parse_invalidTime_throwsParseException() {
        String args = "John m/Meeting t/23-03-2024 14:00-15:00";
        assertThrows(ParseException.class, () -> parser.parse(args));
    }
