...
public class AddressBookParserTest {
    ...
    public void parseCommand_edit() throws Exception {
        ...
        EditClientDescriptor descriptor = new EditPersonDescriptorBuilder(client).build();
    ...
    public void parseCommand_unrecognisedInput_throwsParseException() {
        String s = String.format(MESSAGE_INVALID_COMMAND_FORMAT, HelpCommand.MESSAGE_USAGE);
        assertThrows(ParseException.class, s, () -> parser.parseCommand(""));
    }
