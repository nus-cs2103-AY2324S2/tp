...
//        String uuid1 = iterator.next();
//        String lastFourDigits1 = "10cb";
//        String uuid2 = iterator.next();
//        String lastFourDigits2 = "6fd4";
//        System.out.println(String.format("addRelation %s %s family", lastFourDigits1, lastFourDigits2));
//        assertDoesNotThrow(() ->
//                parser.parse(String.format("addRelation %s %s family", lastFourDigits1, lastFourDigits2)));
//    }
//
//    @Test
...
//                parser.parse("addRelation" + uuid1));
//    }
//
//    @Test
