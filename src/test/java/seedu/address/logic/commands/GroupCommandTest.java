...
class GroupCommandTest {
    ...
    @Test
    public void equals() {
        final GroupCommand standardCommand = new GroupCommand(new NusId(VALID_NUSID_AMY), DESC_AMY_GROUP);

        // same values -> returns true
        GroupCommand.GroupPersonDescriptor copyDescriptor = new GroupCommand.GroupPersonDescriptor(DESC_AMY_GROUP);
