...
public class CommandTestUtil {
    ...
    public static void showBookingAtIndex(Model model, Index targetIndex) {
        ...
        final String[] splitDescription = booking.getDescription().description.split("\\s+");
        model.updateFilteredBookingList(new DescriptionContainsKeywordsPredicate(Arrays.asList(splitDescription[0])));
