...
public class CommandTestUtil {
    ...
    public static final String VALID_CLASS_GROUP_AMY = "B01";
    public static final String VALID_CLASS_GROUP_BOB = "F14";
    ...
    public static final String INVALID_CLASS_GROUP_DESC = " " + PREFIX_CLASS_GROUP; // empty string not allowed for addresses
    public static final String INVALID_TELEGRAM_DESC = " " + PREFIX_TELEGRAM + "hi"; // '*' not allowed in tags
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withClassGroup(VALID_CLASS_GROUP_AMY).withTelegram(VALID_TELEGRAM_AMY).withGithub(VALID_GITHUB_AMY)
                .build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB)
                .withClassGroup(VALID_CLASS_GROUP_BOB).withTelegram(VALID_TELEGRAM_BOB).withGithub(VALID_GITHUB_BOB)
                .build();
    }
