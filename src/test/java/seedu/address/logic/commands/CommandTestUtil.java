...
public class CommandTestUtil {
    ...
    public static final String ORDER_INDEX_DESC_ONE = " " + PREFIX_ORDER_ID + VALID_ORDER_INDEX_ONE;
    public static final String ORDER_INDEX_DESC_TWO = " " + PREFIX_ORDER_ID + VALID_ORDER_INDEX_TWO;
