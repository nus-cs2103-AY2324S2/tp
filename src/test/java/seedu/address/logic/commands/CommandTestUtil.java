...
public class CommandTestUtil {
    ...
    public static final String VALID_TASKS_AMY = "3 6";
    public static final String VALID_TASKS_BOB = "3 6";
    public static final String VALID_TASKS_HUSBAND = "3 6";
    public static final String VALID_TASKS_FRIEND = "3 6";
    ...
    public static final String TASK_DESC_AMY = " " + PREFIX_TASKS + VALID_TASKS_AMY;
    public static final String TASK_DESC_BOB = " " + PREFIX_TASKS + VALID_TASKS_BOB;
    public static final String TASK_DESC_HUSBAND = " " + PREFIX_TASKS + VALID_TASKS_HUSBAND;
    public static final String TASK_DESC_FRIEND = " " + PREFIX_TASKS + VALID_TASKS_FRIEND;
    ...
    public static void assertCommandFailure(Command command, Model actualModel, String expectedMessage) {
        ...
        TaskMasterPro expectedTaskMasterPro = new TaskMasterPro(actualModel.getTaskMasterPro());
        List<Employee> expectedFilteredList = new ArrayList<>(actualModel.getFilteredEmployeeList());

        assertThrows(CommandException.class, expectedMessage, () -> command.execute(actualModel));
        assertEquals(expectedTaskMasterPro, actualModel.getTaskMasterPro());
