...
public class CommandTestUtil {
    ...
    public static final String VALID_INTERVIEWTIME_AMY = "12-12-2022 1400";
    public static final String VALID_INTERVIEWTIME_BOB = "11-12-2022 1400";
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withInterviewTime(VALID_INTERVIEWTIME_AMY).withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
                .withInterviewTime(VALID_INTERVIEWTIME_BOB).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).build();
    }
