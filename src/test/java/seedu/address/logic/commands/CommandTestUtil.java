...
public class CommandTestUtil {
    ...
    public static final String VALID_FUNDING_BOB = "A";
    public static final String VALID_FUNDING_AMY = "A";
    ...
    public static final String INDUSTRY_DESC_BOB = " " + CliSyntax.PREFIX_INDUSTRY + VALID_INDUSTRY_BOB;

    public static final String FUNDING_DESC_AMY = " " + CliSyntax.PREFIX_FUNDING_STAGE + VALID_FUNDING_AMY;
    public static final String FUNDING_DESC_BOB = " " + CliSyntax.PREFIX_FUNDING_STAGE + VALID_FUNDING_BOB;
