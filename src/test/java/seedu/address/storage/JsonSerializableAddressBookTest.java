...
public class JsonSerializableAddressBookTest {
    ...
    private static final Path TYPICAL_APPOINTMENTS_FILE = TEST_DATA_FOLDER
            .resolve("typicalAppointmentsAddressBook.json");
    ...
    public void toModelType_typicalAppointmentsFile_success() throws Exception {
        JsonSerializableAddressBook dataFromFile = JsonUtil.readJsonFile(TYPICAL_APPOINTMENTS_FILE,
                JsonSerializableAddressBook.class).get();
        AddressBook addressBookFromFile = dataFromFile.toModelType();
        AddressBook typicalAppointmentsAddressBookWithAppointments =
                TypicalAppointments.getTypicalAddressBookWithAppointments();
        assertEquals(addressBookFromFile, typicalAppointmentsAddressBookWithAppointments);
    }
