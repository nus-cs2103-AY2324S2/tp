...
public class StorageManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonPatientListStorage patientListStorage = new JsonPatientListStorage(getTempFilePath("ab"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(getTempFilePath("prefs"));
        JsonAppointmentListStorage appointmentListStorage = new JsonAppointmentListStorage(getTempFilePath("ap"));
        storageManager = new StorageManager(patientListStorage, appointmentListStorage, userPrefsStorage);
    }
    ...
    @Test
    public void patientListReadSave() throws Exception {
        /*
         * Note: This is an integration test that verifies the StorageManager is properly wired to the
    ...
    @Test
    public void getPatientListFilePath() {
