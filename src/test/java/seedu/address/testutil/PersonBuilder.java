...
public class PersonBuilder {
    ...
    public static final String DEFAULT_ID = "A0265901E";
    ...
    /**
     * Sets the {@code Intake} of the {@code Person} that we are building.
     */
    public PersonBuilder withIntake(String intake) {
    ...
    public Person build() {
        return new Person(id, major, intake, name, phone, email, address, tags);
    }
