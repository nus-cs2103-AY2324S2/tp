...
public class PersonUtil {
    ...
    public static String getEditPersonDescriptorDetails(UpdatePersonDescriptor descriptor) {
        ...
        descriptor.getDateOfBirth()
                .ifPresent(dateOfBirth -> sb.append(PREFIX_DATEOFBIRTH).append(dateOfBirth).append(" "));
        descriptor.getSex().ifPresent(sex -> sb.append(PREFIX_SEX).append(sex).append(" "));
        descriptor.getStatus().ifPresent(status -> sb.append(PREFIX_STATUS).append(status));
        /*
