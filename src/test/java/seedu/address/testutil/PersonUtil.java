...
public class PersonUtil {
    ...
    public static String getPersonDetails(Person person) {
        ...
        sb.append(PREFIX_HOUSINGTYPE + person.getHousingType() + " ");
    ...
    public static String getSellerDetails(Seller seller) {
        ...
        sb.append(PREFIX_HOUSINGTYPE + seller.getHousingType() + " ");
    ...
    public static String getEditPersonDescriptorDetails(EditPersonDescriptor descriptor) {
        ...
        descriptor.getHousingType().ifPresent(housingType -> sb.append(PREFIX_HOUSINGTYPE).append(" "));
