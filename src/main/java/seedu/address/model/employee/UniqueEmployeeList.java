 ...
 * An employee is considered unique by comparing using {@code #isSameEmployee(Employee)}. As such, adding and updating
 * of employees uses Employee#Employee(Employee) for equality so as to ensure that the employee being added or updated
 * is unique in terms of identity in the UniqueEmployeeList. However, the removal of a employee uses
