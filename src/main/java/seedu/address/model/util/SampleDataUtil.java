    ...
    public static Person[] getSamplePersons() {
        return new Person[]{
            new Person(new Name("Alex"), new Name("Yeoh"), new Phone("87438807"), new Sex("m"),
                    new EmploymentType("ft"), new Address("Blk 30 Geylang Street 29, #06-40"),
            ...
            new Person(new Name("Bernice"), new Name("Yu"), new Phone("99272758"), new Sex("f"),
                    new EmploymentType("pt"), new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
            ...
            new Person(new Name("David"), new Name("Li"), new Phone("91031282"),
                new Sex("m"), new EmploymentType("ft"), new Address("Blk 436 Serangoon Gardens Street 26, #16-43"),
            ...
            new Person(new Name("Irfan"), new Name("Ibrahim"), new Phone("92492021"), new Sex("m"),
                    new EmploymentType("ft"), new Address("Blk 47 Tampines Street 20, #17-35"),
            ...
            new Person(new Name("Roy"), new Name("Balakrishnan"), new Phone("92624417"), new Sex("m"),
                new EmploymentType("pt"), new Address("Blk 45 Aljunied Street 85, #11-31"),
