...
public class Maintainer extends Person {
    ...
    public Maintainer updateNote(Note note) {
        Maintainer maintainerToReturn = new Maintainer(this.getName(), this.getPhone(), this.getEmail(), this.getAddress(), note,
    ...
    public Maintainer updateRating(Rating rating) {
        Maintainer maintainerToReturn = new Maintainer(this.getName(), this.getPhone(), this.getEmail(), this.getAddress(), this.getNote(),
