...
import seedu.address.model.person.note.exceptions.DuplicateNoteException;
import seedu.address.model.person.note.exceptions.NoteNotFoundException;
...
public class UniqueNoteList implements Iterable<Note> {
     ...
     * The note date-time of {@code editedNote} must not be the same as another existing note in the list.
     */
