...
/**
 * Tests that a {@code Person}'s {@code Nric} matches the given Nric prefix
 */
public class NricContainsMatchPredicate implements Predicate<Person> {
    ...
    public boolean test(Person person) {
        return StringUtil.startsWithWordIgnoreCase(person.getNric().value, prefixToMatch);
    }
