...
/**
 * Tests that a {@code Person}'s {@code Bolt} is within the bounds specified.
 */
public class BoltWithinBoundsPredicate implements Predicate<Person> {
    ...
    public boolean test(Person person) {
        switch (operator) {
        case "<":
            return person.getBolt().numOfBolts < value;
        case "<=":
            return person.getBolt().numOfBolts <= value;
        case ">":
            return person.getBolt().numOfBolts > value;
        case ">=":
            return person.getBolt().numOfBolts >= value;
        case "=":
            return person.getBolt().numOfBolts.equals(value);
        default:
            return false;
        }
    }
