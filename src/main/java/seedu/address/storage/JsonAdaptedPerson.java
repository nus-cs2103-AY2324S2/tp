...
class JsonAdaptedPerson {
    ...
    public Student toModelType() throws IllegalValueException {
        ...
        if (intake == null) {
            throw new IllegalValueException(String.format(MISSING_FIELD_MESSAGE_FORMAT, Intake.class.getSimpleName()));
        }
        ...
        return new Student(modelId, modelMajor, modelIntake, modelName, modelPhone, modelEmail, modelAddress, modelTags);
    }
