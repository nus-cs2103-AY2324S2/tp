...
public class StorageManager implements Storage {
     ...
     */
    public StorageManager(AddressBookStorage addressBookStorage, UserPrefsStorage userPrefsStorage, CourseStorageName courseStorageName) {
        this.addressBookStorage = addressBookStorage;
        this.userPrefsStorage = userPrefsStorage;
        this.courseNameStorage = courseStorageName;
    }
