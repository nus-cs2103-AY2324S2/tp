...
public class HelpMessages extends Messages {
    ...
    public static final String MESSAGES_SHOWING_ADD_MAINTAINER_HELP_MESSAGE =
            "Opened help window for pooch-maintenance command.";
    public static final String MESSAGES_SHOWING_ADD_STAFF_HELP_MESSAGE =
            "Opened help window for pooch-staff command.";
    public static final String MESSAGES_SHOWING_ADD_SUPPLIER_HELP_MESSAGE =
            "Opened help window for pooch-supplier command.";
