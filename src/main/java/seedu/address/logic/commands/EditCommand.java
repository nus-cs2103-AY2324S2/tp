...
public class EditCommand extends Command {
    ...
    private static Person createEditedPerson(Person personToEdit, EditPersonDescriptor editPersonDescriptor) {
        ...
        seedu.address.model.person.Phone updatedPhone = editPersonDescriptor.getPhone().orElse(personToEdit.getPhone());
    ...
    public static class EditPersonDescriptor {
        ...
        public void setPhone(seedu.address.model.person.Phone phone) {
            this.phone = phone;
        }

        public Optional<seedu.address.model.person.Phone> getPhone() {
