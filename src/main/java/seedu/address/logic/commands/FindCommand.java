...
public class FindCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Finds all companies whose names contain any of "
            ...
            + "Example: " + COMMAND_WORD + " food panda";
    ...
    public CommandResult execute(Model model) {
        ...
        return new CommandResult(
                String.format(Messages.MESSAGE_PERSONS_LISTED_OVERVIEW, model.generateNewFilteredPersonList(predicate).size()),
                        model.generateNewFilteredPersonList(predicate));
    }
