...
public class AddPointsCommand extends Command {
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        int existingPoints = personToEdit.getPoints().getValue();
        int additionalPoints = this.points.getValue();
        int newPointsTotal = existingPoints + additionalPoints;
        Points newPoints = new Points(Integer.toString(newPointsTotal));
        //Points newPoints = new Points(personToEdit.getPoints().value + this.points.value);

        Person editedPerson = new Person(
                personToEdit.getName(), personToEdit.getPhone(), personToEdit.getEmail(),
                personToEdit.getAddress(), personToEdit.getTags(), newPoints);
    ...
    private String generateSuccessMessage(Person person) {
        return String.format(MESSAGE_ADDPOINTS_SUCCESS, this.points.value, person.getName());
    }
}
