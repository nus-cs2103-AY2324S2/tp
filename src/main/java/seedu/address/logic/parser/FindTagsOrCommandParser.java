 ...
 */
public class FindTagsOrCommandParser implements Parser<FindTagsOrCommand> {
     ...
     */
    public FindTagsOrCommand parse(String args) throws ParseException {
        ...
        return new FindTagsOrCommand(new TagsOrFoundPredicate(tagSet));
    }
