...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        parseAllergensForEdit(argMultimap.getAllValues(PREFIX_ALLERGENS))
                .ifPresent(editPersonDescriptor::setAllergens);
    ...
    /**
     * Parses {@code Collection<String> allergens} into a {@code Set<Allergen>} if {@code allergens} is non-empty.
     * If {@code allergens} contain only one element which is an empty string, it will be parsed into a
     * {@code Set<Allergen>} containing zero allergens.
     */
    private Optional<Set<Allergen>> parseAllergensForEdit(Collection<String> allergens) throws ParseException {
        assert allergens != null;
