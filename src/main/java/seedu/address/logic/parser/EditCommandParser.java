...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_NAME, PREFIX_PHONE, PREFIX_EMAIL, PREFIX_ADDRESS,
                        PREFIX_BIRTHDAY_DATE, PREFIX_TAG, PREFIX_ATTENDANCE);
    ...
    private Optional<Set<Attendance>> parseAttendancesForEdit(Collection<String> attendances) throws ParseException {
        ...
        Collection<String> attendanceSet = attendances.size() == 1 && attendances.contains("") ? Collections.emptySet()
                : attendances;
        return Optional.of(ParserUtil.parseAttendances(attendanceSet));
    }
}
