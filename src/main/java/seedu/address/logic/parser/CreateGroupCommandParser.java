...
public class CreateGroupCommandParser implements Parser<CreateGroupCommand> {
    ...
    public CreateGroupCommand parse(String args) throws ParseException {
        ...
        ArgumentMultimap argMultiMap =
                ArgumentTokenizer.tokenize(args, PREFIX_COURSEMATE, PREFIX_SKILL, PREFIX_TELEGRAM);
        ...
        return new CreateGroupCommand(name, queryableCourseMateSet, skillSet, telegramChat);
    }
}
