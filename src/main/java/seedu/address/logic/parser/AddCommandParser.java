...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ...
        Set<Timeslots> timeslotList = ParserUtil.parseTimeslots(argMultimap.getAllValues(PREFIX_TIMESLOT));
        Set<Grade> gradeList = ParserUtil.parseGrades(argMultimap.getAllValues(PREFIX_GRADE));

        Student student = new Student(name, phone, email, address, timeslotList, gradeList);
