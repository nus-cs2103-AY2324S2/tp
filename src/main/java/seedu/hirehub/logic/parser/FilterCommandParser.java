...
public class FilterCommandParser implements Parser<FilterCommand> {
    ...
    public FilterCommand parse(String args) throws ParseException {
        requireNonNull(args);
        ArgumentMultimap argMultimap = ArgumentTokenizer.tokenize(args, PREFIX_TITLE, PREFIX_EMAIL);
        ...
        argMultimap.verifyNoDuplicatePrefixesFor(PREFIX_TITLE, PREFIX_EMAIL);
